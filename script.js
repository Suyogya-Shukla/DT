...
document.getElementById("task-title").textContent = courseData.tasks[0].task_title;
document.getElementById("task-description").textContent = courseData.tasks[0].task_description;
document.getElementById("asset-title").textContent = courseData.tasks[0].assets[0].asset_title;
document.getElementById("asset-description").textContent = courseData.tasks[0].assets[0].asset_description;
document.getElementById("asset2-title").textContent = courseData.tasks[0].assets[1].asset_title;
document.getElementById("asset2-description").textContent = courseData.tasks[0].assets[1].asset_description;
document.getElementById("asset3-title").textContent = courseData.tasks[0].assets[2].asset_title;
document.getElementById("asset3-description").textContent = courseData.tasks[0].assets[2].asset_description;
document.getElementById("asset4-title").textContent = courseData.tasks[0].assets[3].asset_title;
document.getElementById("asset4-description").textContent = courseData.tasks[0].assets[3].asset_description;

if (courseData && courseData.tasks && courseData.tasks[0] && courseData.tasks[0].assets && courseData.tasks[0].assets[0]) {
    const videoElement = document.getElementById("asset-video");
    if (videoElement) {
        videoElement.src = courseData.tasks[0].assets[0].asset_content;
    }
}
